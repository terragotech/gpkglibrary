...
-(void) exportGeoPackage: (NSString *) database withName: (NSString *) name toDirectory: (NSString *) directory{
    ...
    NSString * file = [directory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.gpkg",name]];
//    NSString * file = directory;
    ...
    [[NSFileManager defaultManager] copyItemAtPath:documentsDbFile toPath:file error:&error];
    if (![fileManager fileExistsAtPath:file])  {
